...
impl Classify for Chapter {
    ...
    {
        ClassificationResult::Confident(Chapter, 0.95)
    }
}
...
impl Classify for SubChapter {
    ...
    where
        ...
        E: Debug + Display + Error,
    {
        ClassificationResult::Confident(SubChapter, 0.90)
    }
}
...
impl Classify for Diagram {
    ...
    where
        ...
        E: Debug + Display + Error,
    {
        ClassificationResult::Probable(Diagram, 0.75)
    }
}
...
impl Classify for DataTable {
    ...
    where
        ...
        E: Debug + Display + Error,
    {
        ClassificationResult::Probable(DataTable, 0.80)
    }
}
